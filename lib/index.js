...
const { merge, requireResolve } = require('./utils')
const appConfig = require('./appConfig')()
const token = appConfig.token()

const highlightStyles = path.resolve(requireResolve('highlight.js'), 'styles')

function setupApp() {
  const app = express()

  app.use('/static/highlight', mw.serveStatic(highlightStyles))
